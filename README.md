...
```ruby
pod 'Tor', :podspec => 'https://raw.githubusercontent.com/iCepa/Tor.framework/v407.8.1/TorStatic.podspec'
```
...
cd Tor/tor
git fetch
git checkout tor-0.4.7.8 # Find latest versions with git tag -l
